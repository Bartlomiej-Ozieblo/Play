...
public class HoloCircularProgressBar extends View {
    ...
    private OnSizeSetupReady setupReadyListener = null;

    public interface OnSizeSetupReady {
    ...
    public void setSetupReadyListener(OnSizeSetupReady setupReadyListener) {
        this.setupReadyListener = setupReadyListener;
    }
	...
	protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        if (setupReadyListener != null) {
            setupReadyListener.onReady(mRadius);
        }
	}
